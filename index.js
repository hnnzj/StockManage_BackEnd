...
const product_Routes = require("src/api/routes/productRoutes");
const clientes_Routes = require("src/api/routes/clientesRoutes");
const pedidos_Routes = require("src/api/routes/pedidosRoutes");
